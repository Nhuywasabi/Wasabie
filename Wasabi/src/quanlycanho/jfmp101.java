...
public class jfmp101 extends javax.swing.JFrame {
    ...
    public jfmp101() {
     ...
     public ArrayList<ListDanhSach> userList() {
        ...
        try {
            ...
            ListDanhSach lids;
            while (rs.next()) {
                lids = new ListDanhSach(rs.getInt("id"), rs.getString("name"), rs.getString("sdt"), rs.getString("diachi"), rs.getString("thoigian"), rs.getString("ngaybatdau"));
                userList.add(lids);
    ...
    private void initComponents() {
        ...
        jTable1_List.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Họ tên", "Năm sinh", "Số diện thoại", "Giới tính", "Title 6"
            }
        ));
