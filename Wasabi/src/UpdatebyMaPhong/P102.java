 ...
 * @author 1102l
 */
public class P102 extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(opt ==0){
            ...
            try {
               String url = "jdbc:sqlserver://localhost;databaseName=QLVL;"
            ...
            String password = "sa";
                ...
                String query = "Delete From DonDep where id =" + value;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
         String url = "jdbc:sqlserver://DESKTOP-S66I291\\SQLEXPRESS;databaseName=QLVL;"
                    + "encrypt=true;trustServerCertificate=true;sslProtocol=TLSv1.2";
            String username = "sa";
            String password = "sa";
            ...
            int row = jTable1_List.getSelectedRow();
            String value = (jTable1_List.getModel().getValueAt(row, 0).toString());
            String query = "Update Cleaner SET name = ? , sdt = ? , diachi = ? , thoigian = ? , ngaybatdau = ?  where id =" + value;
            PreparedStatement ps = con.prepareStatement(query);
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(url,username,password);
            String query = "INSERT INTO Cleaner(name,sdt,diachi,thoigian,ngaybatdau)VALUES(?,?,?,?,?)";
            PreparedStatement ps = con.prepareStatement(query);
            ps.setString(1, txtHoten.getText());
            ps.setString(2, txtNamsinh.getText());
            ps.setString(3, txtSdt.getText());
        ...
        public ArrayList<ListDanhSach> userList() {
            ...
            String password = "sa";
                ...
                Connection con = DriverManager.getConnection(url,username,password);
                String query1 = "SELECT * FROM Cleaner";
                Statement st = con.createStatement();
                ResultSet rs = st.executeQuery(query1);
                ListDanhSach lids;
                while (rs.next()) {

                    lids = new ListDanhSach(rs.getInt("id"), rs.getString("name"), rs.getString("sdt"), rs.getString("diachi"), rs.getString("thoigian"), rs.getString("ngaybatdau"),rs.getString("tinhtrang"));
                    userList.add(lids);
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void jTable1_ListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1_ListMouseClicked
        ...
        lblthanhtoan.setText(userList().get(i).getTinhtrang().toString());
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P102.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
